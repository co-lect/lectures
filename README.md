...
| [`03-llm-fundamentals/`](./03-llm-fundamentals/index.html) | LLM はどう動くか | 10 枚 |
...
- **最初の一声**（コピペ用）:
  > 「これから https://co-lect.github.io/lectures/00-about/ を読みます。読み終わったら、私が詰まった点や改善提案を一緒に整理して、Issue / Discussion / PR のどれにするか提案してください。投稿案を作る前に、私の同意確認と個人情報（実名・会社名・社内パス・API キー等）の匿名化を必ず行ってください。必要なら Discussions の Q&A / Show and tell / Ideas、Issue（bug-report / improvement）、PR のどれが適切かまで分けてください。」
...
https://co-lect.github.io/lectures/03-llm-fundamentals/
